...
print(xtrain)
ytrain=df.opinion[:2400]
print(ytrain)
tmp2=df.opinion[3200:]
ytrain=pd.concat([ytrain,tmp2],ignore_index=True)
xtest=df.cleaned[2400:3200]
ytest=df.opinion[2400:3200]
...
xtrain=pd.concat([xtrain,tmp],ignore_index=True)
print(xtrain)
ytrain=df.opinion[:6000]
print(ytrain)
tmp2=df.opinion[8125:]
ytrain=pd.concat([ytrain,tmp2],ignore_index=True)
xtest=df.cleaned[6000:8000]
ytest=df.opinion[6000:8000]
